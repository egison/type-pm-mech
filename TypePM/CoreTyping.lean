...
provisional role in the surface/core architecture and records the two public
bridges: successful inference constructs core evidence, and erasing the
evidence recovers surface typing.
