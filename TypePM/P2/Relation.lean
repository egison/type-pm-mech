...
/-!
# P2 relations and two-sorted schemes
...
/-- Flexible capability variables occurring anywhere in a P2 type. -/
...
/-- Flexible capability variables occurring in a list of P2 types. -/
...
/-- Ordinary target-type variables occurring in a P2 type. -/
...
/-- Ordinary target-type variables occurring in a list of P2 types. -/
...
/-- The principal P2 scheme for `something`. -/
...
/-- The shared-target-variable P2 scheme `∀a. a -> Matcher none a`. -/
