...
/-!
# Concrete P2 runtime typing

This module connects the type-erased operational objects in
`TypePM.P2.Semantics` directly to the coverage-required two-sorted source
calculus in `TypePM.P2.Source`.  No abstract runtime specification, oracle, or
...
/-- Coverage-preserving runtime value typing for the concrete P2 source core. -/
