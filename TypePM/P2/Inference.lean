...
/-!
# Executable P2 inference trace foundation

This module is the syntax-directed, terminating foundation for the two-sorted
Algorithm W described by the P2 specification.  It deliberately separates
three layers:
...
The declarative `HasTy`/`ClauseTy` reconstruction is connected only after a
...
/--
The three primitive constraints solved by P2 inference.
