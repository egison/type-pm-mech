...
This file defines the two-sorted type syntax used by the P2 matcher
...
/-- P2 types, with separate capability and target indices on matchers. -/
inductive Ty where
  | var     : TypePM.TyVar → Ty
  | skolem  : Nat → Ty
  | unit
...
/-- Executable structural equality for P2 types. -/
...
/-- Executable structural equality for P2 type lists. -/
