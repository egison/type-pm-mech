...
/-!
# Fresh supplies and executable two-sorted instantiation

This module supplies the terminating fresh-variable layer used by P2
...
/-- A freshly allocated two-sorted batch is range-fixed. -/
