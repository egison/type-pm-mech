...
$\mathsf{inferType}$が返す何らかの型と，その返値自身のDD derivationを同時に得る．さらに同じ
$\Sighat,\Gamma,e$に対する二つのDD target $\tau_1,\tau_2$には，共通の決定的な実行target $\upsilon$と，
...
別の結果であり，$\mathsf{RuntimeTyping}$全体のprincipality反例をこのDD結果には流用しない．
...
Lean~4に機械化済みである．同じsourceのDD targetが全residual二sortmetaの局所renamingを法として
